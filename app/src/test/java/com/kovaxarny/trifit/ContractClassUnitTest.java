...
public class ContractClassUnitTest {
    ...
    @Test
    public void BodyStatsContract_inner_class_exists() throws Exception {
        Class[] innerClasses = BodyStatsContract.class.getDeclaredClasses();
        assertEquals("There should be 1 Inner class inside the contract class", 1, innerClasses.length);
    }

    @Test
    public void BodyStatsContract_inner_class_type_correct() throws Exception {
        Class[] innerClasses = BodyStatsContract.class.getDeclaredClasses();
    ...
    @Test
    public void BodyStatsContract_inner_class_members_correct() throws Exception {
        Class[] innerClasses = BodyStatsContract.class.getDeclaredClasses();
        assertEquals("Cannot find inner class to complete unit test", 1, innerClasses.length);
        Class entryClass = innerClasses[0];
    ...
    @Test
    public void ExerciseContract_inner_class_exists() throws Exception {
        Class[] innerClasses = ExerciseContract.class.getDeclaredClasses();
        assertEquals("There should be 1 Inner class inside the contract class", 1, innerClasses.length);
    }

    @Test
    public void ExerciseContract_inner_class_type_correct() throws Exception {
        Class[] innerClasses = ExerciseContract.class.getDeclaredClasses();
        assertEquals("Cannot find inner class to complete unit test", 1, innerClasses.length);
        Class entryClass = innerClasses[0];
        assertTrue("Inner class should implement the BaseColumns interface", BaseColumns.class.isAssignableFrom(entryClass));
    ...
    @Test
    public void ExerciseContract_inner_class_members_correct() throws Exception {
        Class[] innerClasses = ExerciseContract.class.getDeclaredClasses();
        assertEquals("Cannot find inner class to complete unit test", 1, innerClasses.length);
        Class entryClass = innerClasses[0];
        Field[] allFields = entryClass.getDeclaredFields();
