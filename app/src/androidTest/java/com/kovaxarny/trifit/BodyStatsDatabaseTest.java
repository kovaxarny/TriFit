...
public class BodyStatsDatabaseTest {

    /* Context used to perform operations on the database and create BodyStatsDbHelper */
    ...
    public void insert_single_record_test() throws Exception {
        ...
        String emptyQueryError = "Error: No Records returned from bodystats query";
